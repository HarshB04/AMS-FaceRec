...
app.get("/students", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to fetch students: ${err.message}` }, 500);
  }
});
...
app.get("/students/:id", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to fetch student: ${err.message}` }, 500);
  }
});
...
app.post("/students", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to create student: ${err.message}` }, 500);
  }
});
...
app.put("/students/:id", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to update student: ${err.message}` }, 500);
  }
});
...
app.delete("/students/:id", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to delete student: ${err.message}` }, 500);
  }
});
...
app.get("/courses", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to fetch courses: ${err.message}` }, 500);
  }
});
...
app.post("/courses", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to create course: ${err.message}` }, 500);
  }
});
...
app.put("/courses/:id", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to update course: ${err.message}` }, 500);
  }
});
...
app.delete("/courses/:id", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to delete course: ${err.message}` }, 500);
  }
});
...
app.get("/attendance", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to fetch attendance: ${err.message}` }, 500);
  }
});
...
app.post("/attendance", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to log attendance: ${err.message}` }, 500);
  }
});
...
app.delete("/attendance/:id", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to delete attendance record: ${err.message}` }, 500);
  }
});
...
app.get("/instructors", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to fetch instructors: ${err.message}` }, 500);
  }
});
...
app.get("/instructors/:id", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to fetch instructor: ${err.message}` }, 500);
  }
});
...
app.post("/instructors", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to create instructor: ${err.message}` }, 500);
  }
});
...
app.put("/instructors/:id", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to update instructor: ${err.message}` }, 500);
  }
});
...
app.delete("/instructors/:id", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to delete instructor: ${err.message}` }, 500);
  }
});
...
app.post("/course-instructors", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to assign instructor: ${err.message}` }, 500);
  }
});
...
app.delete("/course-instructors/:courseId/:instructorId", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to unassign instructor: ${err.message}` }, 500);
  }
});
...
app.get("/stats/admin", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to fetch admin stats: ${err.message}` }, 500);
  }
});
...
app.get("/stats/teacher", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to fetch teacher stats: ${err.message}` }, 500);
  }
});
...
app.get("/stats/student", async (c: Context) => {
  try {
    ...
    return c.json({ error: `Failed to fetch student stats: ${err.message}` }, 500);
  }
});
